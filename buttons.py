...
def main_nopka(lang):
    ...
    if lang == "uz":
        ...
        shtrix = "Ombordagi Tovarlar"
        errror = "Xatoliklarni to'g'irlash"
        back_product = "Yo'ldagi Tovarlar"
        back = 'ortga'
    else:
        place = "Наш адрес 📍"
        ...
        price = 'Цены'
        otchot = 'Фото отчет'
        shtrix = "Товары которые на складе"
        errror = "Исправить ошибки"
        back_product = "Товары которые в пути"
        back = 'назад'
    ...
    btn10 = KeyboardButton(back_product)
